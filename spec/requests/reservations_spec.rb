...
RSpec.describe "`Reservations` requests" do
  ...
  let(:reservation) { Reservation.create!(status: "confirmed", client_id: client.id, seance_id: seance.id, ticket_desk_id: ticket_desk.id, seat: "A10") }
  ...
  describe "POST /reservations" do
    it "returns status 201" do
      post("/reservations/online", params: { reservation: {  status: "confirmed", client_id: client.id, seance_id: seance.id, ticket_desk_id: ticket_desk.id, seat: "A5" } } )
