...
seance_2 = Seance.create!(id: 2, date: '2021-07-11 10:00:00', hall_id: hall_2.id, movie_id: movie_1.id)
...
reservation_1 = Reservation.create!(id: 1, status: 'confirmed', seance_id: seance_1.id, ticket_desk_id: ticket_desk_1.id, client_id: client_1.id, user_id: 1)
reservation_2 = Reservation.create!(id: 2, status: 'confirmed', seance_id: seance_2.id, ticket_desk_id: ticket_desk_2.id, client_id: client_2.id, user_id: 1)
reservation_3 = Reservation.create!(id: 3, status: 'canceled', seance_id: seance_3.id, ticket_desk_id: ticket_desk_1.id, client_id: client_3.id, user_id: 2)

ticket_1 = Ticket.create!(id: 1, sort: 'regular', price: 20, reservation_id: 1, seat: 'A1', key: 'ais73ueir902n.kd')
ticket_2 = Ticket.create!(id: 2, sort: 'regular', price: 20, reservation_id: 2, seat: 'A2', key: 'gjfy27308ksuqisk')
ticket_3 = Ticket.create!(id: 3, sort: 'regular', price: 20, reservation_id: 1, seat: 'A3', key: '4-ske,ci-=wlr9sx')
