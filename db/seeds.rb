...
seance_1 = Seance.create!(id: 1, date: '2021-06-11 20:40:00', hall_id: hall_1.id, movie_id: movie_1.id)
seance_2 = Seance.create!(id: 2, date: '2021-06-11 10:00:00', hall_id: hall_2.id, movie_id: movie_1.id)
seance_3 = Seance.create!(id: 3, date: '2021-06-11 12:30:00', hall_id: hall_3.id, movie_id: movie_3.id) 
