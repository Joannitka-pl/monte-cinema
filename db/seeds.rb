...
client_1 = Client.create!(id: 1, name: "Joanna Kowal", email: "joanna.kowal@mail.com", age:20, real_user: false)
...
reservation_1 = Reservation.create!(id: 1, status: "confirmed", seance_id: seance_1.id, ticket_desk_id: ticket_desk_1.id, client_id: client_1.id, seat: "A4", user_id: 1)
reservation_2 = Reservation.create!(id: 2, status: "confirmed", seance_id: seance_2.id, ticket_desk_id: ticket_desk_2.id, client_id: client_2.id, seat: "B5", user_id: 1)
reservation_3 = Reservation.create!(id: 3, status: "canceled", seance_id: seance_3.id, ticket_desk_id: ticket_desk_1.id, client_id: client_3.id, seat: "C8", user_id: 2)
